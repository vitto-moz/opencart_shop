...
<div id="content">
	...
	<div class="content">
			...
			$customer_table_data .="<div class='table-responsive'><table class='table table-bordered table-hover'><thead><tr><td class='text-center'>First Name</td><td class='text-left'>Last Name</td><td class='text-left'>Email</td><td class='text-left'>Telephone</td><td class='text-left'>Status</td></tr></thead><tbody>";						
...
<script type="text/javascript"><!--
    $('#button-save1').on('click', function() {
        var base_url="<?php echo HTTP_CATALOG; ?>"+'index.php?route=account/account/passingcustomervalues';
