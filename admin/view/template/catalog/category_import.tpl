...
<div id="content">
	...
	<div class="content">
			...
			$category_table_data .="<div class='table-responsive'><table class='table table-bordered table-hover'><thead><tr><td class='text-center'>Category Name</td><td class='text-left'>Image</td><td class='text-left'>Sort Order</td><td class='text-left'>Status</td></tr></thead><tbody>";						
...
if($categorydata['status']==1){$status="Enable";}else{$status="Disable";}

								$category_table_data .="<tr><td class='left'>".$langval['name']."</td><td class='left'>".$categorydata['image']."</td><td class='left'>".$categorydata['sort_order']."</td><td class='left'>".$status."</td></tr>";
...
<script type="text/javascript"><!--
    $('#button-save1').on('click', function() {
        var base_url="<?php echo $base; ?>"+'index.php?route=account/account/passingcustomervalues';
